							...
							<div class="row">
								<div class="col-md-12">
									...
									<div class="news-image">
										<img width="100%" src="<?= base_url('assets/img/news/').$row['gambar'] ?>"></p>
									</div>
										...
										<div class="row">
											...
											<div class="col">
												<div class="auth-title">
													...
													<div class="float-none">Developer at GBJ solution. I love to travel, make new friends. I prefer tea over coffee.</div><br>
												</div>
											</div>
										</div>
									</div>
